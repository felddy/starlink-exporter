...
var file_spacex_api_device_dish_proto_rawDesc = []byte{
	...
	0x07, 0x10, 0xf0, 0x07, 0x4a, 0x06, 0x08, 0xf0, 0x07, 0x10, 0xf1, 0x07, 0x22, 0xd4, 0x07, 0x0a,
	...
	0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x43, 0x6c, 0x61, 0x73, 0x73, 0x4a, 0x06, 0x08, 0xe9, 0x07,
	...
	0x65, 0x73, 0x74, 0x22, 0x67, 0x0a, 0x1d, 0x44, 0x69, 0x73, 0x68, 0x47, 0x65, 0x74, 0x4f, 0x62,
	...
	0x72, 0x18, 0x03, 0x20, 0x03, 0x28, 0x02, 0x52, 0x03, 0x73, 0x6e, 0x72, 0x22, 0xff, 0x02, 0x0a,
	...
	0x01, 0x28, 0x08, 0x52, 0x09, 0x69, 0x73, 0x48, 0x65, 0x61, 0x74, 0x69, 0x6e, 0x67, 0x22, 0x46,
	...
	0x70, 0x73, 0x53, 0x61, 0x74, 0x73, 0x22, 0x81, 0x04, 0x0a, 0x14, 0x44, 0x69, 0x73, 0x68, 0x4f,
	...
	,
	...
	0x69, 0x64, 0x4a, 0x06, 0x08, 0xee, 0x07, 0x10, 0xef, 0x07, 0x22, 0x54, 0x0a, 0x18, 0x44, 0x69,
	...
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2a, 0x3c, 0x0a, 0x11, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x6f,
	...
	0x4c, 0x45, 0x10, 0x02, 0x2a, 0x43, 0x0a, 0x09, 0x44, 0x69, 0x73, 0x68, 0x53, 0x74, 0x61, 0x74,
...
var file_spacex_api_device_dish_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_spacex_api_device_dish_proto_goTypes = []interface{}{
	...
	(DishState)(0),                        // 1: SpaceX.API.Device.DishState
	(DishOutage_Cause)(0),                 // 2: SpaceX.API.Device.DishOutage.Cause
	(SetTestModeRequest_RfMode)(0),        // 3: SpaceX.API.Device.SetTestModeRequest.RfMode
	(*DishStowRequest)(nil),               // 4: SpaceX.API.Device.DishStowRequest
	(*DishStowResponse)(nil),              // 5: SpaceX.API.Device.DishStowResponse
	(*DishGetContextRequest)(nil),         // 6: SpaceX.API.Device.DishGetContextRequest
	(*DishGetContextResponse)(nil),        // 7: SpaceX.API.Device.DishGetContextResponse
	(*DishOutage)(nil),                    // 8: SpaceX.API.Device.DishOutage
	(*DishGetHistoryResponse)(nil),        // 9: SpaceX.API.Device.DishGetHistoryResponse
	(*DishGetStatusResponse)(nil),         // 10: SpaceX.API.Device.DishGetStatusResponse
	(*DishGetObstructionMapRequest)(nil),  // 11: SpaceX.API.Device.DishGetObstructionMapRequest
	(*DishGetObstructionMapResponse)(nil), // 12: SpaceX.API.Device.DishGetObstructionMapResponse
	(*DishAlerts)(nil),                    // 13: SpaceX.API.Device.DishAlerts
	(*DishGpsStats)(nil),                  // 14: SpaceX.API.Device.DishGpsStats
	(*DishObstructionStats)(nil),          // 15: SpaceX.API.Device.DishObstructionStats
	(*DishAuthenticateResponse)(nil),      // 16: SpaceX.API.Device.DishAuthenticateResponse
	(*SelfTestRequest)(nil),               // 17: SpaceX.API.Device.SelfTestRequest
	(*SelfTestResponse)(nil),              // 18: SpaceX.API.Device.SelfTestResponse
	(*StartDishSelfTestRequest)(nil),      // 19: SpaceX.API.Device.StartDishSelfTestRequest
	(*StartDishSelfTestResponse)(nil),     // 20: SpaceX.API.Device.StartDishSelfTestResponse
	(*SetTestModeRequest)(nil),            // 21: SpaceX.API.Device.SetTestModeRequest
	(*SetTestModeResponse)(nil),           // 22: SpaceX.API.Device.SetTestModeResponse
	(*DishSetConfigRequest)(nil),          // 23: SpaceX.API.Device.DishSetConfigRequest
	(*DishSetConfigResponse)(nil),         // 24: SpaceX.API.Device.DishSetConfigResponse
	(*DishGetConfigRequest)(nil),          // 25: SpaceX.API.Device.DishGetConfigRequest
	(*DishGetConfigResponse)(nil),         // 26: SpaceX.API.Device.DishGetConfigResponse
	(*DeviceInfo)(nil),                    // 27: SpaceX.API.Device.DeviceInfo
	(*DeviceState)(nil),                   // 28: SpaceX.API.Device.DeviceState
	(*ChallengeResponse)(nil),             // 29: SpaceX.API.Device.ChallengeResponse
	(*DishConfig)(nil),                    // 30: SpaceX.API.Device.DishConfig
}
var file_spacex_api_device_dish_proto_depIdxs = []int32{
	27, // 0: SpaceX.API.Device.DishGetContextResponse.device_info:type_name -> SpaceX.API.Device.DeviceInfo
	28, // 1: SpaceX.API.Device.DishGetContextResponse.device_state:type_name -> SpaceX.API.Device.DeviceState
	2,  // 2: SpaceX.API.Device.DishOutage.cause:type_name -> SpaceX.API.Device.DishOutage.Cause
	8,  // 3: SpaceX.API.Device.DishGetHistoryResponse.outages:type_name -> SpaceX.API.Device.DishOutage
	27, // 4: SpaceX.API.Device.DishGetStatusResponse.device_info:type_name -> SpaceX.API.Device.DeviceInfo
	28, // 5: SpaceX.API.Device.DishGetStatusResponse.device_state:type_name -> SpaceX.API.Device.DeviceState
	13, // 6: SpaceX.API.Device.DishGetStatusResponse.alerts:type_name -> SpaceX.API.Device.DishAlerts
	8,  // 7: SpaceX.API.Device.DishGetStatusResponse.outage:type_name -> SpaceX.API.Device.DishOutage
	14, // 8: SpaceX.API.Device.DishGetStatusResponse.gps_stats:type_name -> SpaceX.API.Device.DishGpsStats
	15, // 9: SpaceX.API.Device.DishGetStatusResponse.obstruction_stats:type_name -> SpaceX.API.Device.DishObstructionStats
	0,  // 10: SpaceX.API.Device.DishGetStatusResponse.mobility_class:type_name -> SpaceX.API.Device.UserMobilityClass
	29, // 11: SpaceX.API.Device.DishAuthenticateResponse.dish:type_name -> SpaceX.API.Device.ChallengeResponse
	3,  // 12: SpaceX.API.Device.SetTestModeRequest.rf_mode:type_name -> SpaceX.API.Device.SetTestModeRequest.RfMode
	30, // 13: SpaceX.API.Device.DishSetConfigRequest.dish_config:type_name -> SpaceX.API.Device.DishConfig
	30, // 14: SpaceX.API.Device.DishSetConfigResponse.updated_dish_config:type_name -> SpaceX.API.Device.DishConfig
	30, // 15: SpaceX.API.Device.DishGetConfigResponse.dish_config:type_name -> SpaceX.API.Device.DishConfig
