...
issue](https://github.com/cisagov/starlink-exporter/issues) in this
...
request](https://github.com/cisagov/starlink-exporter/pulls), you will
...
pyenv virtualenv <python_version_to_use> starlink-exporter
pyenv local starlink-exporter
